...
#
# # TODO: get city name and country name for each user by using cityId from user, countryCode
...
#         cursor.close()
#
# ## TODO: 1. Function to create table dimUser, 2. Function to check SCD type 2 for address and dedicator when it fill data from op
#
#
...
#                                                    experience_level, dedicator, datetime2.now(),
#                                                    '', 1, 1))
#             else:
...
#                 cursor_dwh.execute(update_query, (datetime2.now(), latest_version, 0, user_id))
#
...
#                 handle_dimUser_scd(conn_op, conn_dwh)
#
#                 # Close connections
#                 conn_op.close()
#                 conn_dwh.close()
